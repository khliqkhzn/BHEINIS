...
// Set category to 'Women'
$categoryName = 'Women';

// ✅ Log activity: user visited Women category
if (isset($_SESSION['user_id'])) {
    $activity_type = "View Category";
    $activity_details = "Visited Women category page";
...
<head>
  <meta charset="UTF-8" />
  <title>Women's Collection - BHEINIS</title>
...
<div class="top-header">
  <div class="logo-search-container">
    ...
    <form action="search.php" method="GET" class="search-form">
      ...
      <input type="text" name="q" placeholder="Search Women's Products..." required />
...
<!-- Navigation Bar -->
<nav class="main-nav">
  <a href="women.php" class="active">WOMENS</a>
