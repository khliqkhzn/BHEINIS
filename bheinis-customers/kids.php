...
// ✅ Log activity: user visited Kids category
if (isset($_SESSION['user_id'])) {
    $activity_type = "View Category";
    $activity_details = "Visited Kids category page";
...
<div class="top-header">
  ...
  <input type="text" name="q" placeholder="Search Kid's Products..." required />
